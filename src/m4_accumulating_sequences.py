...
def run_test_make_simple_string():
    ...
    # Test 3
    expected = '25-'
    actual = make_simple_string(25, 25)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    # Test 3
    expected = '25'
    actual = make_less_simple_string(25, 25)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        a = circles[k].center.x
        aa = circles[k].center.y
        b = circles[k].radius
        bb =bb + [ rg.Rectangle(rg.Point(a -b,aa - b ),rg.Point(a +b,aa + b ))]
    return bb
